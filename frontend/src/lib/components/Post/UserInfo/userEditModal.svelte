<script lang="ts">
    ...
    onMount(async () => {
        ...
        confirm_password = '';
        image_success = false;
        gender = userInfo.user.gender ? userInfo.user.gender.charAt(0).toUpperCase() + userInfo.user.gender.slice(1) : '';
        getTags();
        fetchDegreeName();
...
{#if modalShown}
    ...
    >
        <svelte:fragment slot="content">
            <div class="flex gap-2">
                <div class="flex flex-col w-full">
                    <label for="first_name" class="text-sm font-semibold mb-1">First Name</label>
                    <input
                    id="first_name"
                ...
                <div class="flex flex-col w-full">
                    <label for="last_name" class="text-sm font-semibold mb-1">Last Name</label>
                    <input
                    id="last_name"
            ...
            <div class="flex flex-col w-full mt-2">
                <label for="date_of_birth" class="text-sm font-semibold mb-1">Date of Birth</label>
                <input
                    id="date_of_birth"
            ...
            <div class="flex flex-col w-full mt-2">
                <label for="gender" class="text-sm font-semibold mb-1">Gender</label>
                <select
                    id="gender"
                    bind:value={gender}
                    class="w-full rounded-lg border-2 border-gray-300 p-2 focus:border-blue-500 focus:outline-none"
            ...
            <div class="flex flex-col w-full mt-2">
                <label for="degree" class="text-sm font-semibold mb-1">Degree</label>
                <SearchBox
            ...
            <div class="flex flex-col w-full mt-2">
                <label for="year_of_study" class="text-sm font-semibold mb-1">Year of Study</label>
                <input
                    id="year_of_study"
            ...
            <div class="flex flex-col w-full mt-2">
                <label for="tags" class="text-sm font-semibold mb-1">Tags</label>
                <SearchBox
                    classStyle="w-full border-2 border-gray-300 rounded-lg p-2 mt-2 focus:outline-none focus:border-blue-500"
                    marginTop=""
            ...
            <div class="flex flex-col w-full mt-2">
                <label for="new_password" class="text-sm font-semibold mb-1">New Password</label>
                <input
                    id="new_password"
                    bind:value={password}
                    type="password"
            ...
            <div class="flex flex-col w-full mt-2">
                <label for="confirm_password" class="text-sm font-semibold mb-1">Confirm Password</label>
                <input
                    id="confirm_password"
        ...
        <svelte:fragment slot="actions">
            <input type="file" accept="image/*" id={"fileInput"} class="hidden" on:change={fileSelected} />
            <button
                class="{image_success ? 'bg-green-500 hover:bg-green-500' : 'bg-yellow-500 hover:bg-yellow-600'} rounded px-4 py-2 text-white"
