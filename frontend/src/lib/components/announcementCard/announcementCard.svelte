<script lang="ts">
  export let postedName: string = "Alex";
  export let communityHeader: string = "Tech Innovators";
  export let community: string = "Software Development";
  ...
  <div class="bg-gray-100 dark:bg-gray-800 p-4 rounded-lg shadow-md w-full max-w-2xl">
    ...
    <div class="mt-3 flex justify-between items-center">
      <div class="flex flex-wrap gap-2">
        {#each tags as tag}
        <span class="text-sm bg-gray-300 dark:bg-gray-600 px-2 py-1 rounded">
          {tag}
        </span>
        {/each}
      </div>
