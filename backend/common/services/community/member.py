...
class CommunityMemberClient:
    ...
    def __new__(cls):
        with cls._lock:
            if cls._instance is None:
                cls._instance = super(CommunityMemberClient, cls).__new__(cls)
    ...
    def initialise(cls, endpoint_url: str, redis_url: str):
        """
        Set the configuration for CommunityMemberClient. This would also handle auth/encryption.
    ...
    def _initialise(self):
        ...
        """
        if not self._config:
            raise ValueError("CommunityMemberClient not initialised")
    ...
    def _reconnect(self):
        ...
        self._stub = community_member_management_pb2_grpc.MemberManagementStub(self._channel)
        self._redis_client = redis.from_url(self._redis_url)

    def promote(self, req: community_member_management_pb2.UserRequest, session_id: int) -> community_member_management_pb2.MemberActionResponse:
        """
        ...
        if user_data:
            ...
            return self._grpc_call_with_retry(self._stub.PromoteUser, req)
    ...
    def ban(self, req: community_member_management_pb2.UserRequest, session_id) -> community_member_management_pb2.MemberActionResponse:
        ...
        if user_data:
            ...
            return self._grpc_call_with_retry(self._stub.BanUser, req)
