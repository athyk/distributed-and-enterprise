...
import grpc
from backend.common.proto import community_searching_pb2, community_searching_pb2_grpc


class CommunitySearchingClient:
    """
    ...
    def __new__(cls):
        with cls._lock:
            if cls._instance is None:
                cls._instance = super(CommunitySearchingClient, cls).__new__(cls)
    ...
    def initialise(cls, endpoint_url: str, redis_url: str):
        """
        Set the configuration for CommunitySearchingClient. This would also handle auth/encryption.
    ...
    def _initialise(self):
        ...
        """
        if not self._config:
            raise ValueError("CommunitySearchingClient not initialised")
    ...
    def _reconnect(self):
        ...
        self._stub = community_searching_pb2_grpc.CommunitySearchingStub(self._channel)
        self._redis_client = redis.from_url(self._redis_url)

    def search(self, req: community_searching_pb2.Filter, session_id: int) -> community_searching_pb2.CommunityFilter:
        """
        ...
        return self._grpc_call_with_retry(self._stub.CommunitySearch, req)
