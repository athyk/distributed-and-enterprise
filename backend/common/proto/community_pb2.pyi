...
class CommunityCreateRequest(_message.Message):
    __slots__ = ("name", "description", "public", "tags", "degrees")
    ...
    def __init__(self, name: _Optional[str] = ..., description: _Optional[str] = ..., public: bool = ..., tags: _Optional[_Iterable[str]] = ..., degrees: _Optional[_Iterable[str]] = ...) -> None: ...

class CommunityUpdateRequest(_message.Message):
    __slots__ = ("id", "name", "description", "public", "tags", "degrees")
    ...
    tags: _containers.RepeatedScalarFieldContainer[str]
    degrees: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, id: _Optional[int] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., public: bool = ..., tags: _Optional[_Iterable[str]] = ..., degrees: _Optional[_Iterable[str]] = ...) -> None: ...
