...
class GetRequest(_message.Message):
    ...
    page: str
    limit: str
    def __init__(self, user_id: _Optional[int] = ..., email: _Optional[str] = ..., first_name: _Optional[str] = ..., last_name: _Optional[str] = ..., email_verified: _Optional[int] = ..., page: _Optional[str] = ..., limit: _Optional[str] = ...) -> None: ...
...
class DeleteRequest(_message.Message):
    ...
    is_self: bool
    otp: str
    def __init__(self, user_id: _Optional[int] = ..., is_self: bool = ..., otp: _Optional[str] = ...) -> None: ...
