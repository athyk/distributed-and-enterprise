...
from backend.common.proto.account_post_pb2 import AccountPostCreateRequest, AccountPostResponse
...
def create_post(request: WSGIRequest):
    ...
    try:
        res: AccountPostResponse = client.create(req)
