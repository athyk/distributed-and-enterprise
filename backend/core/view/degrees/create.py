...
from backend.common.proto.degree_pb2 import DegreeCreateRequest, DegreeCreateResponse
from backend.common.services import DegreesClient


def create_degree(request: WSGIRequest):
    """
    Creates a degree
    """
    if not request.body:
    ...
    try:
        res: DegreeCreateResponse = client.create(req)
