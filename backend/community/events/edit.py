...
def edit_event(event_id: int, user_id: int, community_id: int, title: str, description: str, location: str, datetime: str, duration: int) -> tuple[bool, int, list, int]:
    """
    ...
    if False in [event_verify, user_verify, community_verify, title_verify, description_verify, location_verify, datetime_verify, duration_verify]:

        all_errors = [event_error, user_error, community_error, title_error, description_error, location_error, datetime_error, duration_error]
